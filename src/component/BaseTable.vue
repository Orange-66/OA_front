                ...
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <b-button v-show="showUpdate" variant="primary" @click="toUpdate(scope.row)">修改</b-button>&nbsp;&nbsp;
                            <b-button v-show="showDelete" variant="outline-danger" @click="toDelete(scope.row)">删除</b-button>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
...
export default {
    props:{
        ...
        showUpdate:{default:true},//是否展示修改按钮，默认展示
        showDelete:{default:true},//是否展示删除按钮，默认展示
    },
   data() {
      return {
          currentPage: 1,
